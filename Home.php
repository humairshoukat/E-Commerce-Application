<html>
        ...
        <link rel="shortcut icon" href="//cdn.shopify.com/s/files/1/0566/0839/1368/files/32by32_32x32.png?v=1628683838" type="image/png">
        <title>Overlays Clothing</title>
        </head>
    <body>
        <style>
    ...
    color: #e53637;
        ...
        <section id="Navbar">
            ...
            <section id="header-2">
              ...
              <p>________</p>
              <a href="shop.html"><button type="submit" class="btn border-dark btn-dark p-2 ps-4 pe-4 m-2">  Shop Now</button></a>
